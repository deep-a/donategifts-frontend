...
async function registerUserWithFireBase(data: { email: string; password: string }): Promise<Token> {
...
async function loginUserWithFireBase(data: { email: string; password: string }): Promise<Token> {
  const { email, password } = data;
  try {
...
export const registerSubmit = async (data: { email: string; password: string }): Promise<Token> => {
...
export const loginSubmit = async (data: { email: string; password: string }): Promise<Token> => {
