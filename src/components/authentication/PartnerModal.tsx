  ...
  return (
    <div className={modalContainerClass}>
      <div className={modalTitleContainerClass}>
        ...
        <div className={modalTitleClass}>Signing up as a Foster Care Partner?</div>
        <div
      ...
      <div className={modalBodyClass}>
        ...
        <div className={blockColumnClass}>
          <div className={blockRowClass}>
            <div className={block}>
              <FontAwesomeIcon icon={faBan} className={bodyIconClass} size="lg" />
            ...
            <div className={block}>
              <FontAwesomeIcon icon={faCheckSquare} className={bodyIconClass} size="lg" />
          ...
          <div className={blockRowClass}>
            <div className={block}>
              <FontAwesomeIcon icon={faEnvelope} className={bodyIconClass} size="lg" />
            ...
            <div className={block}>
              <FontAwesomeIcon icon={faExclamationTriangle} className={bodyIconClass} size="lg" />
