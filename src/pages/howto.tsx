  ...
  return (
    <BaseLayout pageTitle="How does Donategifts work?">
        ...
        <div className="w-full bg-cover bg-center dg-bg-howto">
          <div className="flex items-center justify-center h-full w-full">
            <div className="text-center font-cool">
              <h1 className="dg-color-blue text-4xl font-semibold">How Does It Work For</h1>
              <div className="text-3xl">
                <a href="#donor">{/* <Button className=" mt-4 font-cool mr-5" children="Donors" /> */}</a>
                and
                <a href="#partner">{/* <Button className=" mt-4 ml-5" children="Partners" /> */}</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="donor" className="relative pt-4 w-full dg-bg-yel-80">
        <div className="py-20">
          <h1 className="font-cool dg-color-blue text-center text-4xl">How do I send gifts as a donor?</h1>
        </div>
        <div className="items-center flex flex-wrap px-4">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold text-white font-cool">Step 1</h3>
          ...
          <div className="w-full md:w-4/12 mx-auto">
            <Image alt="select the wishcard to donate a gift" className="max-w-full px-12" src={wishCardClick} />
          </div>
        </div>
        <div className="items-center flex flex-wrap px-4 mt-10 pt-24">
          <div className="w-full md:w-4/12 mx-auto">
            <Image alt="how to check out" className="max-w-full px-12" src={howToCheckOut} />
          </div>
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold text-white font-cool">Step 2</h3>
              <p className="mt-4 text-2xl font-quick dg-color-blue font-semibold">Wish donation secure checkout</p>
              <p className="mt-4 text-lg font-quick dg-color-blue leading-relaxed">
        ...
        <div className="items-center flex flex-wrap px-4 pt-24 pb-18">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold text-white font-cool">Step 3</h3>
              <p className="mt-4 text-2xl font-quick dg-color-blue font-semibold">Get 100% tax deductible receipt</p>
              <p className="mt-4 text-lg font-quick dg-color-blue leading-relaxed">
          ...
          <div className="w-full md:w-4/12 mx-auto">
            <Image alt="select the wishcard to donate a gift" className="max-w-full px-12" src={howToGift} />
          </div>
        </div>
        <div className="w-full">
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              <h1 className="font-cool dg-color-blue text-4xl">Ready to donate gifts?</h1>
              <Link href="/wishcards">
                wishcards
                {/* <Btn className=" mt-6 text-lg font-quick" children="Start Browsing Wishes" /> */}
              </Link>
            </div>
          </div>
        </div>
      ...
      <section id="partner" className="relative pt-4 w-full dg-bg-cream">
        <div className="py-20">
          <h1 className="font-cool dg-color-blue text-center text-4xl">How do I create wishes as a partner?</h1>
        </div>
        <div className="items-center flex flex-wrap px-4">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold dg-color-yel font-cool">Step 1</h3>
              <p className="mt-4 text-2xl font-quick dg-color-blue font-semibold">Register as a partner</p>
              <p className="mt-4 text-lg font-quick dg-color-blue leading-relaxed">
          ...
          <div className="w-full md:w-4/12 mx-auto">
            <Image alt="select the wishcard to donate a gift" className="max-w-full px-12" src={registerImg} />
          </div>
        </div>
        <div className="items-center flex flex-wrap px-4 mt-10 pt-24">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold dg-color-yel font-cool">Step 2</h3>
              <p className="mt-4 text-2xl font-quick dg-color-blue font-semibold">Become verified</p>
              <p className="mt-4 text-lg font-quick dg-color-blue leading-relaxed">
          ...
          <div className="w-full md:w-4/12 mx-auto">
            <h3 className="text-3xl font-semibold dg-color-yel font-cool">Step 3</h3>
            <p className="mt-4 text-2xl font-quick dg-color-blue font-semibold">Create wish cards</p>
            <p className="mt-4 text-lg font-quick dg-color-blue leading-relaxed">
        ...
        <div className="items-center flex flex-wrap px-4 pt-24 pb-18">
          <div className="w-full md:w-5/12 mx-auto px-2 py-2">
            <div className="md:pr-12">
              <h3 className="text-3xl font-semibold dg-color-yel font-cool">Step 4</h3>
              <p className="mt-4 text-2xl font-quick dg-color-blue font-semibold">Get notified</p>
              <p className="mt-4 text-lg font-quick dg-color-blue leading-relaxed">
          ...
          <div className="w-full md:w-4/12 mx-auto">
            <Image alt="select the wishcard to donate a gift" className="max-w-full px-12" src={notified} />
          </div>
        </div>
        <div className="w-full">
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              <h1 className="font-cool dg-color-blue text-4xl">Ready to become our non profit partner?</h1>
              <Link href="/signup">
                signup
                {/* <Btn className=" mt-6 text-lg font-quick" children="Register Your Agency" /> */}
              </Link>
            </div>
          </div>
        </div>
